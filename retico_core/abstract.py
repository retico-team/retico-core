...
import traceback
import structlog
from retico_core.log_utils import ServerLogger, log_exception, TerminalLogger, FileLogger
...
class AbstractModule:
    ...
    def __init__(self, queue_class=IncrementalQueue, meta_data={}, **kwargs):
        ...
        self.server_logger = self.server_logger.bind(module=self.name())
    ...
    def append(self, update_message):
        ...
        if len(update_message) != 0:
            ...
            self.server_logger.info("append UM", **args)
        else:
                ...
                for buffer in self._left_buffers:
                    with self.mutex:
                        ...
                        if update_message:
                            ...
                            self.server_logger.info("process_update")
    ...
    def prepare_run(self):
        ...
        self.server_logger.info("prepare_run")
    ...
    def shutdown(self):
        ...
        self.server_logger.info("shutdown")
